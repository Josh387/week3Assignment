...
the last element of the array (do not use numbers to reference the last element, find it programmatically,
...
/* 7.	Write a function that takes two parameters, word and n, as arguments and returns
 the word concatenated to itself n number of times. (i.e. if I pass in ‘Hello’ and 3, 
    ...
    function communication(word, n) {
        if (n > 0)
          return word.repeat(n);
        else
          return "";
      }
      communication("Hello", 3);
...
console.log(greaterThan([10, 15, 20, 12, 32, 23]))
